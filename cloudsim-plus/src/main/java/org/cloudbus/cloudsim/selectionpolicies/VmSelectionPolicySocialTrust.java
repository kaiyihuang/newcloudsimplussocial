 ...
 */
public class VmSelectionPolicySocialTrust implements VmSelectionPolicy {
	@Override
	public Optional<Vm> getVmToMigrate(final Host host) {
        ...
        final Comparator<Vm> vmComparator = comparingInt(vm -> ((VmSocial)vm).owner.social_credit);
