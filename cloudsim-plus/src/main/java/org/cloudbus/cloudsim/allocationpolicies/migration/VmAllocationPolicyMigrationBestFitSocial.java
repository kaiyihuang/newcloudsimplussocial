...
public class VmAllocationPolicyMigrationBestFitSocial extends VmAllocationPolicyMigrationBestFitStaticThreshold{
    /**
     ...
     */
    public VmAllocationPolicyMigrationBestFitSocial(final VmSelectionPolicy vmSelectionPolicy) {
        this(vmSelectionPolicy, DEF_OVER_UTILIZATION_THRESHOLD);
    }

    public VmAllocationPolicyMigrationBestFitSocial(
